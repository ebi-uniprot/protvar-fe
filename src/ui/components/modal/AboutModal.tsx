...
function AboutModal() {
  ...
  const aboutModelDiv = useRef(null)
  useOnClickOutside(aboutModelDiv, useCallback(() => setShowModel(false), []));

  const showHideClassName = showModel ? 'modal d-block' : 'modal d-none';
  return <div id="divAbout" ref={aboutModelDiv}>
    <a onClick={() => setShowModel(true)}>About</a>
