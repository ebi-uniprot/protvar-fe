      ...
      <td colSpan={TOTAL_COLS} className="expanded-row">
        <div className="significances-groups">
          <div className="column">
            ...
            <ResidueRegionTable features={apiData.features} foldxs={apiData.foldxs} pockets={apiData.pockets} interactions={apiData.interactions} refAA={refAA} variantAA={variantAA} />
