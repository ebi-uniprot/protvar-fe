			...
			<Fragment>
				<div className="text-area-search">
					...
					<form onSubmit={this.handleSubmit}>
						...
						<span className="assemly-ref-note">Reference Genome Assembly: GRCh38 (hg38)</span>
						...
						<div id="search-button-group" className="search-button-group">
							...
							{searchTerm ? (
								<Button onClick={this.clearForm}>Clear Input</Button>
							) : (
								<Button onClick={this.useExampleData}>Use Example Input</Button>
							)}
						</div>
					</form>
				</div>
