...
export const SearchHistoryHelp = () => {
  ...
  return <div className="help">
    ...
    <p>Every input has a unique URL, allowing you to share the result, including a specific page of results
    ...
    <p>
      <code>https://www.ebi.ac.uk/ProtVar/result/:inputId[?page=PAGE&pageSize=PAGE_SIZE&assembly=ASSEMBLY&annotation=[functional|population|structural]-row-X]</code>
    </p>

    <p><strong>URL Parameters:</strong></p>
    <ul>
      <li><code>inputId</code>: This can be a 32-character user-input ID or a other input such as a UniProt accession,
        gene symbol, etc.
      </li>
