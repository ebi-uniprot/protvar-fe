...
import { detailsLinkPropTypes, detailsLinkDefaultProps } from '../../other/sharedProps';
...
class ExpandedStructuralSignificance extends Component {
	...
	render() {
		...
		const { structures, allStructures, proteinLength, interactions, ligands, position, accession } = data;
